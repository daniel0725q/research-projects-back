...
import com.quinterodaniel.researchprojects.exception.OAuth2AuthenticationProcessingException;
...
import com.quinterodaniel.researchprojects.security.oauth2.user.OAuth2UserInfo;
import com.quinterodaniel.researchprojects.security.oauth2.user.OAuth2UserInfoFactory;
...
public class UserServiceImpl implements UserService {
	...
	private AppUser buildUser(final SignUpRequest formDTO) {
		...
		roles.add(roleRepository.findByName(Role.ROLE_STUDENT));
