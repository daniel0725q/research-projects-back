...
import com.quinterodaniel.researchprojects.dto.ApiResponse;
import com.quinterodaniel.researchprojects.dto.JwtAuthenticationResponse;
import com.quinterodaniel.researchprojects.dto.LocalUser;
import com.quinterodaniel.researchprojects.dto.LoginRequest;
import com.quinterodaniel.researchprojects.dto.SignUpRequest;
import com.quinterodaniel.researchprojects.dto.SignUpResponse;
import com.quinterodaniel.researchprojects.security.jwt.TokenProvider;
import com.quinterodaniel.researchprojects.service.UserService;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
		try {
			AppUser appUser = userService.registerNewUser(signUpRequest);
			if (signUpRequest.isUsing2FA()) {
				QrData data = qrDataFactory.newBuilder().label(appUser.getEmail()).secret(appUser.getSecret()).issuer("JavaChinna").build();
